            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="img/e2cake.jpg" alt="Blog">
                            </div>
                            <div class="blog-content">
                                <h2 class="blog-title">Cake</h2>
                                <div class="blog-text">
                                    <p>
                                        They are baked, especially for you. Mouthwatering taste with exceptional service.
                    ...
                    <div class="col-md-6">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="img/e2p.jpg" alt="Blog">
                            </div>
                            <div class="blog-content">
                                <h2 class="blog-title">Pastry</h2>
                                <div class="blog-text">
                                    <p>
                                        Freshly baked all Day. Every day! Sweet as mother’s tenderness. Sweet moments of life. I 've never met a problem a pastry couldn't fix.
                                    </p>
                                    <a class="btn custom-btn" href="menu.php">View Menu</a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="img/e2sv.jpeg" alt="Blog">
                            </div>
                            <div class="blog-content">
                                <h2 class="blog-title">Snacks (Veg.)</h2>
                                <div class="blog-text">
                                    <p>
                    ...
                    <div class="col-md-6">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="img/e2snv.jpg" alt="Blog">
                            </div>
                            <div class="blog-content">
                                <h2 class="blog-title">Snacks (Non Veg.)</h2>
                                <div class="blog-text">
                                    <p>
                                        When you are busy or when you are in hurry, the one food that makes your life easy is frozen food.The food that lasts longer. So,reap the benefits of our frozen foods!
                                    </p>
                                    <a class="btn custom-btn" href="menu.php">View Menu</a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="pagination justify-content-center">
                            <li class="page-item"><a class="page-link" href="explore.php">Previous</a></li>
                            <li class="page-item"><a class="page-link" href="explore.php">1</a></li>
                            <li class="page-item active"><a class="page-link" href="explore2.php">2</a></li>
                            <li class="page-item"><a class="page-link" href="explore3.php">3</a></li>
                            <li class="page-item"><a class="page-link" href="explore3.php">Next</a></li>
                        </ul>  
                    </div>
                </div>
            </div>
