            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                                <h2 class="blog-title">Fast Food</h2>
                                <div class="blog-text">
                                    <p>
                                        Fast food is popular because it's convenient, it's cheap, and it tastes good.If you are out,and starving,and need a bite to eat,then you need fast food.
                                    </p>
                    ...
                    <div class="col-md-6">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="img/e3f.jpg" alt="Blog">
                            </div>
                            <div class="blog-content">
                                <h2 class="blog-title">Frozen Food</h2>
                                <div class="blog-text">
                                    <p>
                                        When you are busy or when you are in hurry, the one food that makes your life easy is frozen food.The food that lasts longer. Reap the benefits of our frozen foods!
                                    </p>
                                    <a class="btn custom-btn" href="menu.php">View Menu</a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="pagination justify-content-center">
                            <li class="page-item"><a class="page-link" href="explore2.php">Previous</a></li>
                            ...
                            <li class="page-item active"><a class="page-link" href="explore3.php">3</a></li>
                            <li class="page-item"><a class="page-link" href="explore.php">Next</a></li>
                        </ul>  
                    </div>
                </div>
            </div>
