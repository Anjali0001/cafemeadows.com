                ...
                <div class="owl-carousel">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-text">
                            ...
                            <div class="carousel-btn">
                                <a class="btn custom-btn" href="menuphp">View Menu</a>
                                <a class="btn custom-btn" href="bookingphp">Book Table</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form action="book.php" method="post">
                                <div class="control-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Name" required="required" name="name" pattern="[A-Za-z ]*{20}" title="Only alphabets and white space are allowed" />
